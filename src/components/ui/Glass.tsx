...
export const GlassInput: React.FC<GlassInputProps> = ({ className, label, sizing = 'md', ...props }) => {
  ...
  return (
    <div className="flex flex-col gap-1 w-full relative">
      ...
      <input
        className={cn(
          "bg-white/40 border border-white/50 text-slate-800 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 backdrop-blur-md transition-all shadow-sm",
          sizeClasses[sizing],
          className
        )}
        {...props}
